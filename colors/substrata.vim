...
" Last Updated: Thu  3 Oct 21:31:27 2019
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#20222d', '#cf8164', '#76a065', '#ab924c',
        \ '#8296b0', '#a18daf', '#659ea2', '#b5b4c9', '#5b5f71', '#fe9f7c',
        \ '#92c47e', '#d2b45f', '#a0b9d8', '#c6aed7', '#7dc2c7', '#f0ecfe']
  if has('nvim')
    let g:terminal_color_0 = '#20222d'
  ...
  hi PreProc guifg=#a0b9d8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Type guifg=#8296b0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Function guifg=#8296b0 guibg=NONE guisp=NONE gui=italic cterm=italic
...
if s:t_Co >= 256
  ...
  hi Function ctermfg=67 ctermbg=NONE cterm=italic
